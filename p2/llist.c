 ...
 * frees the list
 ...
 WE DO NOT NEED THIS FOR THE OPERATING SYSTEMS COURSE
 (we will NOT use dynamically allocated data structures)
...
int (*cmp)();
{
    ...
    panic(ERRNO_ASSERT, "ll_insert"); // need to do some form of logging
    return LL_NULL;
}
